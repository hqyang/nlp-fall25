...
All write-ups should use the [ACL style](https://github.com/acl-org/acl-style-files) ([Overleaf link](https://www.overleaf.com/read/crtcwgxzjskr)).
...
In **Homework Assignment 3**, in addition to report results of a re-implementation of an existing work, you should also turn in a brief project proposal that provides an overview of your idea and also contains a brief survey of related work on the topic.
We will provide a list of suggested project ideas for you to choose from, though you may discuss other project ideas with us.
...
The report for HW 3 should be about **four pages long**, and should include the following information:
...
- Reimplementation of one related work, report your scores on their dataset, and perform fine-grained analysis. This should be approximately one page long.
- Description of potential data sets to use for your experiments. This should be approximately half a page long.
